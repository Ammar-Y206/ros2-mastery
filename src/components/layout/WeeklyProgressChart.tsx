 ...
 *
 * When there's no activity (all 7 days have 0 completions), shows a
 * motivating empty state instead of an empty chart.
 */
export function WeeklyProgressChart() {
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card/40 p-5">
      ...
      {hasActivity ? (
        /* Bar chart — only when there's activity */
        ...
        /* Empty state — motivating message instead of empty chart */
        <div className="flex flex-col items-center justify-center gap-2 py-6 text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Complete your first lesson to start tracking activity!
          </p>
        </div>
      )}
    </div>
