  ...
  return (
    <div className="border-t border-sidebar-border/60 px-4 py-3">
      <div className="flex items-center justify-between text-[11px]">
        ...
        <span className="font-mono font-semibold text-sidebar-foreground/80">
          {totalDone}/{totalModules}
        </span>
      </div>
      <div className="mt-1.5 h-1 w-full overflow-hidden rounded-full bg-sidebar-border/60">
        <div
          className="h-full rounded-full bg-gradient-to-r from-cyan-400 to-teal-400 transition-all duration-500"
          style={{
            width: `${totalModules > 0 ? (totalDone / totalModules) * 100 : 0}%`,
          }}
        />
      </div>
    </div>
